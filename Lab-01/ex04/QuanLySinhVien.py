...
class QuanLySinhVien:
    ...
    def updateSinhVien(self, ID):
        ...
        if (sv != None):
            ...
            sex = input("Nhập giới tính mới của sinh viên: ")
            major = input("Nhập chuyên ngành mới của sinh viên: ")
            diemTB = float(input("Nhập điểm mới của sinh viên: "))
    ...
    def showSinhVien(self, listSV):
        print("{:<8} {:<18} {:<8} {:<8} {:<8} {:<8}".format("ID", "Tên", "Giới tính", "Chuyên ngành", "Điểm", "Học lực"))
